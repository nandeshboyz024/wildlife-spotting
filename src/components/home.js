            ...
            <div className='row' style={{margin:'0'}}>
                <div className='col-lg-6'>
                    ...
                    <div style={{display:'flex',justifyContent:'space-around',margin:'20px'}}>
                        <a href="wildlife-spotting/detection" style={{textDecoration:'none'}}>
                        ...
                        <a href="wildlife-spotting/explore" style={{textDecoration:'none'}}>
            ...
            <div style={{display:'flex'}}>
                ...
                <div style={{width:'90%'}}>
                    <div className="container" id='c1'>
                        <a href="/wildlife-spotting/birds" style={{textDecoration:'none'}}>
                        ...
                        <a href="/wildlife-spotting/horses" style={{textDecoration:'none'}}>
                        ...
                        <a href="/wildlife-spotting/giraffes" style={{textDecoration:'none'}}>
                        ...
                        <a href="/wildlife-spotting/persons" style={{textDecoration:'none'}}>
