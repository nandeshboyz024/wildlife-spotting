                ...
                <div style={{width:'90%'}}>
                    <div className={styles.container} id="c1" style={{textAlign:'center'}}>
                        <div className={styles.item +' item-1'} style={{padding:'10px'}}>
                            ...
                            <Image id='img1' src="/imgs/giraffes/angolan-giraffe.png" draggable='true' onDragStart={drag} alt="WildEye" width={300} height={210} />            
                        </div>
                        <div className={styles.item +' item-2'} style={{padding:'10px'}}>
                            <p style={{marginBottom:'0'}}>masai-giraffe</p>
                            <Image id='img2' src="/imgs/giraffes/masai-giraffe.png" draggable='true' onDragStart={drag} alt="WildEye" width={300} height={210}/>            
                        </div>
                        <div className={styles.item +' item-3'} style={{padding:'10px'}}>
                            <p style={{marginBottom:'0'}}>nubian-giraffe</p>
                            <Image id='img3' src="/imgs/giraffes/nubian-giraffe.png" draggable='true' onDragStart={drag} alt="WildEye" width={300} height={210}/>            
                        </div>
                        <div className={styles.item +' item-4'} style={{padding:'10px'}}>
                            <p style={{marginBottom:'0'}}>reticulated-giraffe</p>
                            <Image id='img4' src="/imgs/giraffes/reticulated-giraffe.png" draggable='true' onDragStart={drag} alt="WildEye" width={300} height={210} />            
                        </div>
                        <div className={styles.item +' item-5'} style={{padding:'10px'}}>
                            <p style={{marginBottom:'0'}}>thornicroft-giraffe</p>
                            <Image id='img5' src="/imgs/giraffes/thornicroft-giraffe.png" draggable='true' onDragStart={drag} alt="WildEye" width={300} height={210} />            
                        </div>
                    </div>
                </div>
                <div style={{width:'5%',marginTop:'140px',textAlign:'center'}}>
            ...
            <div className='row' style={{margin:'0'}}>
                ...
                <div className='col-lg-2'>
                    <Link href="/animal-detection/persons" style={{textDecoration:'none'}}>
                        <div className={styles.item} style={{textAlign:'center'}}>
                            <h3>Next Page</h3>
                            <Image src="/imgs/logo11.png" alt="logo11"  width={200} height={140}/>
