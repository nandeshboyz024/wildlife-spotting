...
const renderPredictions = (predictions, canvasRef) => {
    const classesToRender=new Set(['bird','cat','dog','horse','sheep','cow','elephant','bear','zebra','giraffe','person']);
    console.log('hgfohgiugf');
    ...
    predictions.forEach(prediction => {
        ...
        console.log('gfx');
        if(classesToRender.has(prediction.class)){
